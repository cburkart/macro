...
plot(dframe$SavingRate, dframe$CapitalOutput, xlim=c(16,32), ylim=c(0,6), xlab="Average savings (% of GDP) 1970-present", ylab="K/Y Ratio")
textxy(dframe$SavingRate, dframe$CapitalOutput, dframe$CountryName, cex=.8, col='red')
